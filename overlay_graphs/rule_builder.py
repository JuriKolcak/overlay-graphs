...
class RuleBuilder:
    def __init__(self, rule_id: str):
        ...
        self._left: RuleGraph = RuleGraph("left")
        self._context: RuleGraph = RuleGraph("context")
        self._right: RuleGraph = RuleGraph("right")
    ...
    @staticmethod
    def _add_edge_vertices(edge: EdgeTuple, target_graph: RuleGraph, alternative_graphs: List[RuleGraph]):
        for vertex in edge:
    ...
    def _add_side_element(self, element: Union[int, EdgeTuple], label: str, side: RuleGraph, opposite_side: RuleGraph):
    ...
    def _add_side_edge_vertices(self, edge: EdgeTuple, side: RuleGraph):
